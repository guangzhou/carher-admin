    ...
    if provider == "litellm":
        ...
        cfg["models"] = {"providers": {"litellm": {
            ...
            "models": [
                ...
                {"id": "chatgpt-gpt-5.6-sol", "name": "GPT-5.6 Sol", "api": "openai-completions", "reasoning": True, "input": ["text", "image"], "contextWindow": 260000, "maxTokens": 128000, "cost": {"input": 5, "output": 30}},
                {"id": "chatgpt-gpt-5.6-terra", "name": "GPT-5.6 Terra", "api": "openai-completions", "reasoning": True, "input": ["text", "image"], "contextWindow": 260000, "maxTokens": 128000, "cost": {"input": 2.5, "output": 15}},
                {"id": "chatgpt-gpt-5.6-luna", "name": "GPT-5.6 Luna", "api": "openai-completions", "reasoning": True, "input": ["text", "image"], "contextWindow": 260000, "maxTokens": 128000, "cost": {"input": 1, "output": 6}},
